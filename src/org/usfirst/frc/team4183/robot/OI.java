...
public class OI {
	...
	public final LogicalButton btnDownIntake = new ModalButton(operatorController.bTriangle);
	public final LogicalButton btnUpIntake = new ModalButton(operatorController.bCross);
