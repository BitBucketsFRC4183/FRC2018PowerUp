...
public class OI {
	...
	public final LogicalButton btnUpIntake = new ModalButton(operatorController.bTriangle);
	public final LogicalButton btnDownIntake = new ModalButton(operatorController.bCross);
